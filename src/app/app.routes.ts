...
export const routes: Routes = [
  {
    ...
    title: 'ROB AV — GRABACIÓN & EDICIÓN ',
  },
  {
    path: 'fotografia',
    component: FotosComponent,
    title: 'FOTOGRAFÍA — ROB AV',
    data: { fotosCategorias: fotosCategorias },
  },
  {
    path: 'fotografia/' + fotosCategorias[0].id,
    component: FotosCategoriaComponent,
    title: `FOTOS ${fotosCategorias[0].titulo.toUpperCase()} — ROB AV`,
    data: { fotoCategoria: fotosCategorias[0] },
  },
  {
    path: 'fotografia/' + fotosCategorias[1].id,
    component: FotosCategoriaComponent,
    title: `FOTOS ${fotosCategorias[1].titulo.toUpperCase()} — ROB AV`,
    data: { fotoCategoria: fotosCategorias[1] },
  },
  {
    path: 'fotografia/' + fotosCategorias[2].id,
    component: FotosCategoriaComponent,
    title: `FOTOS ${fotosCategorias[2].titulo.toUpperCase()} — ROB AV`,
    data: { fotoCategoria: fotosCategorias[2] },
  },
  {
    path: 'fotografia/' + fotosCategorias[3].id,
    component: FotosCategoriaComponent,
    title: `FOTOS ${fotosCategorias[3].titulo.toUpperCase()} — ROB AV`,
    data: { fotoCategoria: fotosCategorias[3] },
  },
  {
    path: 'fotografia/' + fotosCategorias[4].id,
    component: FotosCategoriaComponent,
    title: `FOTOS ${fotosCategorias[4].titulo.toUpperCase()} — ROB AV`,
  ...
  },
  {
    ...
    title: 'SOBRE MÍ — ROB AV',
  },
  {
    path: 'contacto',
    component: ContactoComponent,
    title: 'CONTACTO — ROB AV',
  },
  {
    path: '**',
    redirectTo: '',
